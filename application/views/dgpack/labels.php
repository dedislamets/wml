	        ...
	        <div class="col">
	            <nav aria-label="breadcrumb">
	                <ol class="breadcrumb">
	                    ...
	                    <li class="breadcrumb-item active" aria-current="page">Hazzard & Handling Labels</li>
	                </ol>
	            </nav>
	        </div>
	    </div>
	        	...
	        	<div class="row">
	        		<div class="col-lg-12">
		                <div class="section-tittle text-center mb-40 sec-title center">
		                    <h2>Hazzard & Handling Labels</h2>
		                </div>
		            </div>
	
	        		<div class="masonry">
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_13.png">
					  ...
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/hazardous-cargo-stickers-500x500-1.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
					      </div>
					  ...
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_14.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
					      </div>
					  ...
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_15.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
					      </div>
