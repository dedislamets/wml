	        ...
	        <div class="col">
	            <nav aria-label="breadcrumb">
	                <ol class="breadcrumb">
	                    ...
	                    <li class="breadcrumb-item active" aria-current="page">Single Packaging</li>
	                </ol>
	            </nav>
	        </div>
	    </div>
	        	...
	        	<div class="row">
	        		<div class="col-lg-12">
		                <div class="section-tittle text-center mb-40 sec-title center">
		                    <h2>Single Packaging</h2>
		                </div>
		            </div>
		            <div class="col-lg-12">
		            	<img src="<?= base_url()?>assets/img/dgpack/product/DOT-hazmat-packaging-image-02.jpg" style="width: 100%; margin-bottom: 10px;">
		            </div>
	        		<div class="masonry">
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_6.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
					        <h1 class="grid__title">Single Pack 1</h1>
					      </div>
					      <div class="mt-auto" >
					  ...
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_7.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
					        <h1 class="grid__title">Single Pack 2</h1>
					      </div>
					      <div class="mt-auto" >
					  ...
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_8.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
