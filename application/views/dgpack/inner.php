	        ...
	        <div class="col">
	            <nav aria-label="breadcrumb">
	                <ol class="breadcrumb">
	                    ...
	                    <li class="breadcrumb-item active" aria-current="page">Inner Packaging</li>
	                </ol>
	            </nav>
	        </div>
	    </div>
	        	...
	        	<div class="row">
	        		<div class="col-lg-12">
		                <div class="section-tittle text-center mb-40 sec-title center">
		                    <h2>Inner Packaging</h2>
		                </div>
		            </div>
		            <div class="col-lg-12">
		            	<img src="<?= base_url()?>assets/img/dgpack/product/Limited-Quantity-label-LQ-Mark.jpg" style="width: 100%; margin-bottom: 10px;">
		            </div>
					
	        		<div class="masonry">
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_9.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
					        <h1 class="grid__title">Golden Care</h1>
					      </div>
					      <div class="mt-auto" >
					  ...
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_10.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
					        <h1 class="grid__title">Ultra-freeze</h1>
					      </div>
					      <div class="mt-auto" >
					  ...
					  <div class="grid">
					    <img src="<?= base_url()?>assets/img/dgpack/product/Screenshot_11.png">
					    <div class="grid__body">
					      <div class="relative">
					        <a class="grid__link" target="_blank" href="/" ></a>
					        <h1 class="grid__title">bio-freeze</h1>
					      </div>
					      <div class="mt-auto" >
