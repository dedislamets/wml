<style type="text/css">
    ...
    .single-item .inner-box h4 a:hover {
        color: #086ad8;
    }
...
<div class="slider-area ">
    <div class="slider-active">
        ...
        <div class="single-slider slider-height d-flex align-items-center" style="background-image: url('assets/img/dgpack/packing_dangerous_goods_desktop.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-9">
                        <div class="hero__caption">
                            <h1>Make Dangerous </h1>
                            <h1>Goods Safe!</h1>
                        </div>
...
<div class="categories-area section-padding30" style="padding-bottom: 0;">
    <div class="container">
        ...
        <p>
            DG Packaging Group is committed to providing total solutions on Dangerous Goods, Biomedical and Temperature Sensitive Packaging. Additionally, we possess expertise in the Repacking and Integrated Logistics Services for chemical, pharmaceutical and biomedical industries.
        </p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                <div class="single-item wow flipInY animated" data-wow-delay="00ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: flipInY;">
                    <div class="inner-box">
                        ...
                        <div class="icon-box">
                            <img src="assets\img\dgpack\dangerous-goods-repackaging.png" class="img-responsive" style="height: 200px;">
                        </div>
                        <h4><a href="#">DANGEROUS GOODS PACKAGING SERVICE</a></h4>
                        <div class="text">Build granular policies to address critical security threats, without disrupting user workflows.</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                <div class="single-item wow flipInY animated" data-wow-delay="300ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: flipInY;">
                    <div class="inner-box">
                        <div class="left-layer"></div>
                        <div class="right-layer"></div>
                        <div class="icon-box"><img src="assets\img\dgpack\ct-9-1920x1280-800x533.png" class="img-responsive" style="height: 200px;"></div>
                        <h4><a href="#">BIOMEDICAL SERVICES</a></h4>
                        <div class="text">Build granular policies to address critical security threats, without disrupting user workflows.</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                <div class="single-item wow flipInY animated" data-wow-delay="600ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 600ms; animation-name: flipInY;">
                    <div class="inner-box">
                        ...
                        <div class="right-layer"></div>
                        <div class="icon-box">
                            <img src="assets\img\dgpack\81YCI0YFJiL._SL1500_.jpg" class="img-responsive" style="height: 200px;margin-left: 50px;">
                        </div>
                        <h4><a href="#">TEMPERATURE-SENSITIVE PACKAGING</a></h4>
                        <div class="text">Build granular policies to address critical security threats, without disrupting user workflows.</div>
                    </div>
                </div>
            </div>
